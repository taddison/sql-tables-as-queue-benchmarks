...
go
alter database TAQBenchmarks set recovery simple;
go
...
alter database TAQBenchmarks add file (name='inmemory_main', filename='D:\SQL\TAQ_inmemory') to filegroup InMemory;
